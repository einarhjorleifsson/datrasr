...
```{r, eval = FALSE}
download.file("http://www.hafro.is/~einarhj/data/Exchange_Data_2016-01-18_21_36_32.csv",
...
par(mfrow=c(1,2),mar=c(2,2,2,2)) # use the result of print(length(uy)) to set up plot for number of graphs. Remember mfrow=c(3,4) means 'plot 12 graphs'
